...
const data = [
  ...
  },
  {
    ...
    description: `Movie info app built with Next.js, NextAuth, MongoDB, and the TMDB API. Features custom REST APIs, parallel/intercepting routes, and a modern UI with ShadCN and Tailwind CSS.`,
    image: `/image.PNG`,
    github_link: `https://github.com/Yosf96633/movies_app`,
    live_link: `https://movies-app-two-rouge.vercel.app/`,
  },
  {
    title: `DemocraSys`,
